      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
            ...
            <Button variant="outline" size="sm" onClick={onBackToCourse} className="self-start sm:self-auto flex-shrink-0">
            ...
            <div className="space-y-4">
              {course.lessons.map((e, index) => {
                return (
                  <div
                    key={e.id}
                    className="flex items-center gap-2 sm:gap-4 p-3 sm:p-4 border border-gray-200 dark:border-gray-700 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 cursor-move transition-colors"
                  >
                    <GripVertical className="h-4 w-4 sm:h-5 sm:w-5 text-gray-400 flex-shrink-0 hidden sm:block" />
                    <div className="flex-shrink-0 w-7 h-7 sm:w-8 sm:h-8 bg-blue-100 dark:bg-blue-900 rounded-full flex items-center justify-center text-xs sm:text-sm font-medium text-blue-600 dark:text-blue-300">
                      {index + 1}
                    </div>
                    ...
                    <div className="flex items-center space-x-1 sm:space-x-2 flex-shrink-0">
                      ...
                      <Button
                        ...
                        className="text-red-600 hover:text-red-700 dark:text-red-400 dark:hover:text-red-300 h-7 w-7 sm:h-8 sm:w-8 p-0"
                      >
